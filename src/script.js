...
const height = loader.load('/wsbg.jpeg')
const texture = loader.load('/mountain.jpg')
const alpha = loader.load('/circle.jpeg')
...
const pointLight = new THREE.PointLight(0x00a4ff, 3)
pointLight.position.x = .6
pointLight.position.y = 5.3
